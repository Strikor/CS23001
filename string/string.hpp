...
public:
    ...
    // Milestone 3
    std::vector<String> split   (char)                    const;  //Splits a string by a given delimiter
...
private:
    ...
    int     stringSize;                                           //Size includes NULL terminator
            ...
            String              (int);                            //Custom size, String(10) - stringSize = 10
            String              (const String&, int);             //Copy constructor with custom size
};
